...
import { LayoutDashboard, Users, CalendarClock, Plane, LineChart, Settings, ScanFace, UserCog } from 'lucide-react';
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/user-management", label: "User & Role Management", icon: UserCog },
];
